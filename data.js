...
values['it']['encounter']=['Semidio','Dio','Sosia','Fantastico','Non-morto','Demone','Elementare','Etereo','Psionico','Metafisico','Extradimensionale','Animale','Umano','Pianta','Sciame','Aberrazione','Costrutto','Automa','Robot','Alieno','Batterio','Virus','Parassita','IA Ribelle','Mutante','X mostruoso','X mutato','X etereo','X alieno','X gigante','X minuscolo','X morto','X morente','X aberrante','Ritira 2 volte','Ritira 2 volte'];
...
values['it']['wants']=['Conoscenza','Vendetta','Rischiare','Aiuto','Potere','Ricchezza','Misteri','Proteggere','Delinquenza','Mostrarsi','Azzuffarsi','Fidarsi','Anarchia','Segreti','Scorciatoie','Scommettere','Valere','Amare','Sacrificare','Sfogare','Solitudine','Supernaturale','L\'ignoto','Famiglia','Evolvere','Stabilirsi','Nascondere','Visibilità','Serenità','Comandare','Tecnologia','Studiare','Comprendere','Vita','Morte','Ritira 2 volte'];
values['it']['personality']=['Sconsiderato','Arrogante','Avido','Credulone','Diffidente','Rancoroso','Codardo','Orgoglioso','Impulsivo','Distruttivo','Pauroso','Smemorato','Spietato','Impietoso','Insicuro','Autonomo','Protettivo','Curioso','Bugiardo','Giusto','Emotivo','Riflessivo','Sottomesso','Generoso','Pietoso','Sicuro','Dipendente','Razionale','Prudente','Negativo','Positivo','Riservato','Ficcanaso','Discreto','Solitario','Ritira 2 volte'];
values['it']['psychosis']=['Alcolismo','Tabagismo','Lussuria','Golosità','Egoismo','Superbia','Avarizia','Isa','Invidia','Accidia','Azzardopatia','Claustrofobia','Numerofobia','Radiofobia','Ipocondria','Emofobia','Aviofobia','Aracnofobia','Piromania','Razzismo','Perfezionismo','Disonestà','Cleptomania','Schizofrenia','Allucinazioni','Delirante','Maniacale','Perfezionista','Disordinato','Distratto','Smemorato','Nictofobia','Agorafobia','Idrofobia','Bibliofobia','Ritira 2 volte'];
values['it']['icon']=['afterburn.svg','cryo-chamber.svg','jetpack.svg','metroid.svg','robot-leg.svg','spoutnik.svg','airtight-hatch.svg','cyborg-face.svg','klingon.svg','missile-mech.svg','rocket-flight.svg','star-gate.svg','alien-bug.svg','defense-satellite.svg','laser-blast.svg','missile-pod.svg','rocket-thruster.svg','starfighter.svg','alien-egg.svg','double-ringed-orb.svg','laser-turret.svg','missile-swarm.svg','rocket.svg','strafe.svg','alien-stare.svg','eclipse.svg','light-sabers.svg','mono-wheel-robot.svg','round-silo.svg','targeting.svg','android-mask.svg','energise.svg','lunar-module.svg','observatory.svg','satellite.svg','techno-heart.svg','astronaut-helmet.svg','energy-tank.svg','mecha-head.svg','power-generator.svg','sentry-gun.svg','tesla-turret.svg','autogun.svg','forward-field.svg','mecha-mask.svg','radar-dish.svg','sinusoidal-beam.svg','ufo.svg','bolter-gun.svg','habitat-dome.svg','mechanical-arm.svg','ray-gun.svg','solar-system.svg','vintage-robot.svg','bubble-field.svg','hazmat-suit.svg','megabot.svg','ringed-planet.svg','space-suit.svg','walking-scout.svg','cannister.svg','jet-fighter.svg','metal-scales.svg','robot-golem.svg','spaceship.svg','zat-gun.svg'];
